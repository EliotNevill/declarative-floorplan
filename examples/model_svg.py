...
with Floorplan("Complete Apartment Floorplan - All Rooms") as fp:
    ...
    h_1171_71 = HC(1171.71)
    h_1187_71 = HC(1187.71)
    h_1210_32 = HC(1210.32)
    h_1220_76 = HC(1220.76)
    h_1226_32 = HC(1226.32)
    h_1310_64 = HC(1310.64)
    h_1325_49 = HC(1325.49)
    ...
    od1_c1 = Vertex(name="Outdoor1 BL", constraints=[h_1325_78, v_492_88])
    od1_c2 = Vertex(name="Outdoor1 TL", constraints=[h_1464_22, v_492_88])
    od1_c3 = Vertex(name="Outdoor1 TR", constraints=[h_1464_22, v_626_59])
    od1_c4 = Vertex(name="Outdoor1 BR", constraints=[h_1325_49, v_626_59])
    ...
    od2_c1 = Vertex(name="Outdoor2 BL", constraints=[h_265_30, v_48_48])
    od2_c2 = Vertex(name="Outdoor2 TL", constraints=[h_45_95, v_48_48])
    od2_c3 = Vertex(name="Outdoor2 TR", constraints=[h_45_95, v_594_09])
    od2_c4 = Vertex(name="Outdoor2 BR", constraints=[h_264_90, v_594_09])
    ...
    dn_c3 = Vertex(name="Dining TR", constraints=[h_910_66, v_632_78])
    dn_c4 = Vertex(name="Dining BR", constraints=[h_910_66, v_786_68])
    ...
    kt_c1 = Vertex(name="Kitchen BL", constraints=[h_1310_64, v_931_84])
    kt_c6 = Vertex(name="Kitchen BR", constraints=[h_910_66, v_931_84])
    ...
    en_c1 = Vertex(name="Entry P1", constraints=[h_1210_32, v_616_78])
    en_c2 = Vertex(name="Entry P2", constraints=[h_1210_32, v_502_56])
    en_c3 = Vertex(name="Entry P3", constraints=[h_1171_71, v_414_74])
    en_c4 = Vertex(name="Entry P4", constraints=[h_1171_71, v_373_42])
    en_c5 = Vertex(name="Entry P5", constraints=[h_941_50, v_373_42])
    en_c6 = Vertex(name="Entry P6", constraints=[h_941_50, v_427_29])
    en_c7 = Vertex(name="Entry P7", constraints=[h_859_10, v_495_90])
    en_c8 = Vertex(name="Entry P8", constraints=[h_859_10, v_616_78])
    ...
    living_corner7 = Vertex(name="Living P7", constraints=[h_280_30, v_495_90])
    ...
    bedroom1_corner1 = Vertex(name="Bedroom1 BL", constraints=[h_586_71, v_482_90])
    bedroom1_corner2 = Vertex(name="Bedroom1 TL", constraints=[h_586_71, v_63_48])
    bedroom1_corner3 = Vertex(name="Bedroom1 TR", constraints=[h_280_30, v_63_48])
    bedroom1_corner4 = Vertex(name="Bedroom1 BR", constraints=[h_280_30, v_482_90])
    ...
    bedroom2_corner1 = Vertex(name="Bedroom2 BL", constraints=[h_1310_64, v_360_42])
    bedroom2_corner2 = Vertex(name="Bedroom2 TL", constraints=[h_1310_64, v_63_48])
    bedroom2_corner3 = Vertex(name="Bedroom2 TR", constraints=[h_941_50, v_63_48])
    bedroom2_corner4 = Vertex(name="Bedroom2 BR", constraints=[h_941_50, v_360_42])
    ...
    bathroom_util_corner1 = Vertex(name="BathUtil P1", constraints=[h_854_39, v_482_90])
    bathroom_util_corner2 = Vertex(name="BathUtil P2", constraints=[h_928_50, v_421_20])
    bathroom_util_corner3 = Vertex(name="BathUtil P3", constraints=[h_928_50, v_240_80])
    bathroom_util_corner4 = Vertex(name="BathUtil P4", constraints=[h_599_71, v_240_80])
    bathroom_util_corner5 = Vertex(name="BathUtil P5", constraints=[h_599_71, v_482_90])
    ...
    undefined_corner1 = Vertex(name="Undefined BL", constraints=[h_928_50, v_225_80])
    undefined_corner2 = Vertex(name="Undefined TL", constraints=[h_928_50, v_63_48])
    undefined_corner3 = Vertex(name="Undefined TR", constraints=[h_736_55, v_63_48])
    undefined_corner4 = Vertex(name="Undefined BR", constraints=[h_736_55, v_225_80])
    ...
    closet_corner1 = Vertex(name="Closet BL", constraints=[h_720_55, v_225_80])
    closet_corner2 = Vertex(name="Closet TL", constraints=[h_720_55, v_63_48])
    closet_corner3 = Vertex(name="Closet TR", constraints=[h_599_71, v_63_48])
    closet_corner4 = Vertex(name="Closet BR", constraints=[h_599_71, v_225_80])
    ...
    wc_corner1 = Vertex(name="WC P1", constraints=[h_1220_76, v_486_56])
    wc_corner2 = Vertex(name="WC P2", constraints=[h_1310_64, v_486_56])
    wc_corner3 = Vertex(name="WC P3", constraints=[h_1310_64, v_373_42])
    wc_corner4 = Vertex(name="WC P4", constraints=[h_1187_71, v_373_42])
    wc_corner5 = Vertex(name="WC P5", constraints=[h_1187_71, v_411_38])
    ...
    tk_corner1 = Vertex(name="TK BL", constraints=[h_1310_64, v_616_78])
    tk_corner2 = Vertex(name="TK TL", constraints=[h_1310_64, v_502_56])
    tk_corner3 = Vertex(name="TK TR", constraints=[h_1226_32, v_502_56])
    tk_corner4 = Vertex(name="TK BR", constraints=[h_1226_32, v_616_78])
